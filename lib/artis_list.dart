...
class ArtisList extends StatefulWidget {
  const ArtisList({super.key});

  @override
  State<ArtisList> createState() => _ArtisListState();
}

class _ArtisListState extends State<ArtisList> {
  final List<Map<String, String>> songArtisList = const [
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // Row for artist avatar, name, and play button
          Padding(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Text(
                      "Adele", // Replace with the actual artist name
                      style:
          ...
          Expanded(
            child: ListView.builder(
              itemCount: songArtisList.length,
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  title: Padding(
                    ...
                    child: Text(
                      songArtisList[index]['title']!,
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                  ),
                  subtitle: Text(
                    songArtisList[index]['artist']!,
