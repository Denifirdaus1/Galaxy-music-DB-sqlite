...
class _DownloaderState extends State<Downloader> {
  ...
  Future<void> downloadAudio(String url) async {
    try {
      ...
      var response = await yt.videos.streamsClient.get(audioStream);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('YouTube MP3 Downloader'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            TextField(
              ...
              decoration: InputDecoration(hintText: 'Masukkan URL YouTube'),
            ),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
